...
export const create_user = () => async (dispatch:any) => {
    if(window.ethereum){
...
export const get_user_details = (account:any) => async (dispatch:any) => {
...
export const get_my_user_details = () => async (dispatch:any) => {
    if(window.ethereum){
