...
import { HiChevronDown, HiSearch, HiUser } from 'react-icons/hi'
import { HiBell, HiMenu, HiX } from 'react-icons/hi'
import { connect } from 'react-redux'
import { NavLink } from 'react-router-dom'
import DarkModeSwitch from '../util/dark_mode_switch'
import { Web3Account } from '../../redux/interfaces/web3_account'

const user = {
  name: 'Chelsea Hagon',
  email: 'chelsea.hagon@example.com',
  imageUrl: 'https://media.licdn.com/dms/image/D4E03AQHxWik2Vf33MQ/profile-displayphoto-shrink_800_800/0/1674018138870?e=1680739200&v=beta&t=zELKbSMe7aNaD82guSK_rcAsxB3_yuNmuIllylc8cms'
}
...
function Navbar({account, ethereum_balance, network, my_user}:Web3Account) {
    ...
    function popoverTransition() {
        ...
        >
            <Popover.Panel className="absolute right-0 z-50 mt-3 w-screen max-w-sm transform px-2 sm:px-0 2xl:max-w-md">
        ...
        <Fragment>
            <Popover as="div" className="relative">
                <Popover.Button
                    ...
                    } lg:hidden inline-flex text-3xl mx-1 rounded-md p-2 items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500`}
                >
                    <HiUser/>
                </Popover.Button>
                {popoverTransition()}
                        ...
                        <div className="flex md:absolute md:left-0 md:inset-y-0 lg:static xl:col-span-2">
                            <div className="flex-shrink-0 flex items-center">
                                <NavLink to="/">
                                    ...
                                    {/* Dark Image */}
                                    <img
                                        src="/images/logos/02.png"
                                        width={45}
                                        height={35}
                                        alt="link"
                                        className="hidden md:flex dark:!flex"
                                    />
                                    {/* Dark Image */}
                                    <img
