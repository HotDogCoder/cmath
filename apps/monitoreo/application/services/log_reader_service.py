...
from apps.monitoreo.application.services_interfaces.log_reader_service_interface import LogReaderServiceInterface
from apps.monitoreo.domain.models.log_reader import LogReader
from apps.monitoreo.infrastructure.repositories.log_reader_repository import LogReaderRepository
